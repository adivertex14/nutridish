...
<body class="d-flex align-items-center justify-content-center py-4">
  ...
  <main class="form-signin text-center w-100 m-auto">
    <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
      ...
      <img class="mb-4" src="assets/img/logo_nutridish.png" alt="" width="72" height="72">
      ...
      <button class="btn btn-bd-primary w-100 py-2" type="submit" name="submit_validate" value="abc">Login</button>
      <p class="mt-5 mb-3 text-body-secondary">&copy; Kelompok 2 - 2025</p>
    </form>
  </main>
